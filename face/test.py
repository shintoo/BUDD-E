...
try:
    ...
    disp = GC9A01(spi=SPI.SpiDev(bus, device),spi_freq=10000000,rst=RST,dc=DC,bl=BL)
...
#    Font1 = ImageFont.truetype("fonts/Font01.ttf",25)
#    Font2 = ImageFont.truetype("fonts/Font01.ttf",35)
#    Font3 = ImageFont.truetype("fonts/Font02.ttf",32)
...
#    draw.text((74, 150),text, fill = "WHITE",font=Font3)
    ...
    draw.line([(120, 120),(70, 70)], fill = "RED",width = 3)
    draw.line([(120, 120),(176, 64)], fill = "GREEN",width = 3)
    draw.line([(120, 120),(120 ,210)], fill = "BLUE",width = 3)   
 
#    im_r=image1.rotate(180)
    disp.ShowImage(image1)
#    time.sleep(10)
#    logging.info("show image")
#    image = Image.open('img/LCD_1inch28_1.jpg')	
#    im_r=image.rotate(180)
#    disp.ShowImage(im_r)
#    time.sleep(3)
#    im_r2 = im_r.rotate(90)
